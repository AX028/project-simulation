...
def abstract_actor(
    ...
    *,
    ...
    return AbstractActorState(
        ...
        tier=tier,
        position=deepcopy(actor.spatial.position),
        facing=deepcopy(actor.spatial.facing),
        velocity=deepcopy(actor.spatial.velocity),
...
def restore_actor(state: AbstractActorState) -> WorldActor:
    ...
    spatial = SpatialEntity(
        ...
        facing=deepcopy(state.facing),
        velocity=deepcopy(state.velocity),
