...
def world_to_dict(world: WorldState) -> dict[str, Any]:
    """Serialize macro world fields without a schema envelope."""
    return {
...
def world_from_dict(raw: object) -> WorldState:
    """Rebuild a world from the mapping produced by ``world_to_dict``."""
